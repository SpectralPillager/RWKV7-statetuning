...
# -*- coding: utf-8 -*-
"""
DAPO State Tuning - Parallel Inference Mode
- Model: rwkv7-g1c-2.9b-20251231-ctx8192
- batch_prompts=4, group_size=8 (4 questions * 8 parallel samples)
...
ZHIPU_API_KEY = "sk-IN4Q7GNmaf5BLlq3glWepqk871uqp8CGHWkbgsuFMJZNF4wM"
...
# =========================================================
# Config - Modified for parallel inference
# =========================================================

@dataclass
class DAPOConfig:
    # sampling / batch - MODIFIED: 4 questions * 8 parallel samples
    batch_prompts: int = 4
    group_size: int = 8
...
# =========================================================
# Trainer - Modified with Adam optimizer
# =========================================================
...
class DAPOStateTuningTrainer:
    def __init__(
        ...
        # MODIFIED: Use Adam instead of AdamW, eps=1e-18, no weight_decay
...
def main():
    ...
    ap.add_argument("--model", type=str, default="rwkv7-g1c-2.9b-20251231-ctx8192", help="model path")
    ap.add_argument("--train_jsonl", type=str, default="train.jsonl")
    ap.add_argument("--out_dir", type=str, default="out_parallel_2.9b")

    ap.add_argument("--total_steps", type=int, default=200)
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--ctx_len", type=int, default=8192)

    # MODIFIED: batch_prompts=4, group_size=8
    ...
    # MODIFIED: log_interval=1 for frequent output
